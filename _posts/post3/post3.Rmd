...
Currently as at the 12th of October 2020, there are over 37 million confirmed coronavirus cases and over 1 million coronavirus related deaths [@worldometer]. The shiny application explores summary figures of confirmed cases, deaths and recoveries across different continents with the use of line-graphs and summary data tables. Further, the application explores 6 countries with the highest cumulative coronavirus confirmed cases through the use of line-graphs. Finally to compare case numbers across all countries, a datatable showing the total case numbers as at 31 July is included. 
...
It is hard to compare case numbers across countries due to the large population differences across countries. Proportion of case numbers by countries populations should be used to improve comparability across countries and continents. However, these values are not included in the coronavirus data set. Further, it may be interesting to assess the effects of population densities (population per kilometer squared) on the spread of coronavirus. In densely populated areas it is harder to contain the spread of the virus due to the lack of ability to socially distance and reduce movement.
